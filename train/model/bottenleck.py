...
class bottleneck(nn.Module):
    def __init__(self,channel_in, channel_out, kernel_size, node,norm,**kwargs):
        super(bottleneck, self).__init__()
        middle_channel = channel_out
        self.cv1=nn.Conv2d(channel_in, middle_channel, kernel_size=kernel_size, stride=kernel_size)
        ...
        self.cv2=conv3x3(middle_channel,  middle_channel)
        ...
        self.cv3=conv3x3(middle_channel, channel_out)
